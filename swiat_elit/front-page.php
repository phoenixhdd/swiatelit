        ...
        <section class="news">
            <div class="aktualnosci">
                ...
                <div class="articles">
                    ...
                    <a href="<?php echo get_site_url(); ?>/category/<?php echo get_post_meta($post->ID, 'aktualnosc_wiecej_link', true); ?>" class="btn btn-more">
                        Zobacz więcej
                    </a>
                </div>
            </div>
                    ...
                    <div class="nowosci">
                        ...
                        <div class="nowosci-content">
                            <?php if ( $the_query->have_posts() ) : ?>
                                <?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
                                    <?php $thumb = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'full' );?>
                                    <div class="nowosci-item" style="background: url('<?php echo $thumb['0'];?>') no-repeat; background-position: center; background-size: cover;">
                        ...
                        <a href="<?php echo get_site_url(); ?>/category/<?php echo get_post_meta($post->ID, 'nowosci_wiecej_link', true); ?>" class="btn btn-more btn-r">
                            Zobacz więcej
                        </a>
                    </div>
